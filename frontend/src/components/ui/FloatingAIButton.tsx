...
export function FloatingAIButton() {
  ...
  return (
    <button
      ...
      className="fixed bottom-12 sm:bottom-10 right-4 sm:right-6 z-40 flex items-center justify-center gap-2 min-w-[44px] min-h-[44px] sm:min-w-0 sm:min-h-0 px-3 sm:px-4 py-2.5 rounded-full bg-terminal-surface border border-git-green/40 text-git-green shadow-lg hover:bg-git-green/10 hover:border-git-green/70 transition-all duration-200 cursor-pointer group"
