      ...
      <div className="flex items-center gap-2 px-4 py-3 bg-terminal-surface border-b border-terminal-border select-none">
        {showDots && (
          <div className="flex items-center gap-1.5">
            <span className="w-3 h-3 rounded-full bg-dot-red block" />
            <span className="w-3 h-3 rounded-full bg-dot-yellow block" />
            <span className="w-3 h-3 rounded-full bg-dot-green block" />
          </div>
        )}
