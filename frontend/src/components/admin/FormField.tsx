...
const inputBase =
  "w-full bg-terminal-bg border rounded-lg px-3 py-2.5 font-mono text-base sm:text-[13px] text-text-primary placeholder-text-faint outline-none transition-colors";
